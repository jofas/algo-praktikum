...
(function( root, factory ) {
    ...
    const __imports = {
        env: {
            "__extjs_781cc202360532df78824ad2ec418326a67395ba": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){return ($1);})());
            },
            ...
            "__extjs_7f1a66b54c6074db926b3f1abee41bd65c411e96": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){return ($1)["d"]. length})());
            },
            "__extjs_601f37725bda2e68ff048773ad4cf878af2a7d7c": function($0, $1, $2) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){return ($1)["d"][($2)];})());
            },
            "__extjs_dfd73b9deb22c859f95920301a56807a57a99367": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){var i = 0 ; for (var x in ($1)["vs"]){i += 1 ;}return i ;})());
            },
            "__extjs_6032ea1a2cbbc5f47f5ea1152e253907e6073781": function($0, $1, $2) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){return ($1)["vs"][($2)];})());
            },
            "__extjs_355090b1964166b4db86de9ad0be22d40347caf8": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){var i = 0 ; for (var x in ($1)["es"]){i += 1 ;}return i ;})());
            },
            "__extjs_45ea206ea06ab8f5b30c297261e3c4993a975cce": function($0, $1, $2) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){return ($1)["es"][($2)];})());
            },
            "__extjs_328bcd158daf87a481895eb6da43a2d088953103": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){return ($1)["graph"]})());
            },
            "__extjs_63a91a3abb2bf59630b80568f4cbc0fb0c3e39cd": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){return ($1)["heap_as_vec"];})());
            },
            "__extjs_a2d32a1ea1e21316fb2cdf51556ed49fdd1c8471": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){console.log (($1));})());
            },
            "__extjs_2563006bbd3f645acc1cef24d765d103c02fe07c": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){return ($1)["closed_list"];})());
            },
            "__extjs_e29345e391d4da8517eb7f31bd91660da06c92be": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){return ($1)["start"];})());
            },
            "__extjs_32f4bb6d6ebb0a29657ffc4ffaed10d6f75d59fb": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){return ($1)["end"];})());
            },
            ...
            "__extjs_a04995a8cd9b53e9b2d8a248c32a33cc521405e6": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){var svg = document.getElementById ("graph"); svg.innerHTML += ($1);})());
            },
            "__extjs_76d8336becb305621d20155e8fa3574cdae476ef": function($0) {
                Module.STDWEB.from_js($0, (function(){document.getElementById ("a_star_next"). remove (); var inf = document.getElementById ("a_star_info"); inf.innerHTML = "Verbindung gefunden."})());
            },
            "__extjs_4b133a87914f3d32fa9e078b7dbed38d095bf49f": function($0, $1, $2) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);Module.STDWEB.from_js($0, (function(){document.getElementById ("a_star_next"). remove (); var inf = document.getElementById ("a_star_info"); inf.innerHTML = "Es gibt keine Verbindung von " + ($1)+ " zu " + ($2);})());
            },
            "__extjs_f66c0dda71dcd0dc9fc6a653f33660e461293f34": function($0, $1) {
                $1 = Module.STDWEB.to_js($1);Module.STDWEB.from_js($0, (function(){document.getElementById ("vertex_dist"). innerHTML += ($1);})());
            },
            "__extjs_0560ade169d7a5b88ffa295c585737cf367c416b": function($0, $1, $2, $3, $4) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);$4 = Module.STDWEB.to_js($4);Module.STDWEB.from_js($0, (function(){var p = document.getElementById ("p_" + ($1). toString ()); p.innerHTML = "ID: " + ($2). toString ()+ " Distanz: " + ($3). toString (); var svg = document.getElementById ("graph"); svg.innerHTML += ($4);})());
            },
            "__extjs_4e8cef01352429bf52f5ba284039b5571b68f735": function($0) {
                Module.STDWEB.from_js($0, (function(){document.getElementById ("dijkstra_next"). remove ();})());
            },
            "__extjs_d29c3d168d49f56623984faccf9a4710415ebac8": function($0, $1, $2, $3, $4, $5, $6) {
                $1 = Module.STDWEB.to_js($1);$2 = Module.STDWEB.to_js($2);$3 = Module.STDWEB.to_js($3);$4 = Module.STDWEB.to_js($4);$5 = Module.STDWEB.to_js($5);$6 = Module.STDWEB.to_js($6);Module.STDWEB.from_js($0, (function(){Module.exports.dijkstra_init = ($1); Module.exports.dijkstra_next = ($2); Module.exports.a_star_init = ($3); Module.exports.a_star_next = ($4); Module.exports.new = ($5); Module.exports.draw = ($6);})());
            },
    ...
    function __load( instance ) {
        ...
        if( typeof module !== 'undefined' && module.exports ) {
            ...
            Rust.ui.exports = Module.exports;
        }
    ...
    if( Module.nodejs ) {
        ...
        const wasm_path = path.join( __dirname, "ui.wasm" );
        ...
        const __promise = fetch( "ui.wasm" )
            .then( response => response.arrayBuffer() )
            .then( bytes => WebAssembly.instantiate( bytes, __imports ) )
            .then( results => {
                __load( results.instance );
                console.log( "Finished loading Rust wasm module 'ui'" );
                return Module.exports;
            })
            .catch( error => {
                console.log( "Error loading Rust wasm module 'ui':", error );
                throw error;
            });
